      ...
      <footer className="bg-card py-12 text-muted-foreground border-t border-border">
        <div className="container mx-auto px-4 sm:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <h4 className="font-bold text-white mb-4 font-heading">Product</h4>
              <ul className="space-y-2 text-sm text-muted-foreground/70">
                <li><Link href="/stress-cards" className="hover:text-primary transition-colors">Stress Cards</Link></li>
                <li><Link href="/stress-management" className="hover:text-primary transition-colors">Methodology</Link></li>
            ...
            <div>
              <h4 className="font-bold text-white mb-4 font-heading">Legal</h4>
              <ul className="space-y-2 text-sm text-muted-foreground/70">
